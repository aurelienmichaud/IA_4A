...
do_get_minimal_tuple([], [Coup, Valeur], [Coup, Valeur]).
do_get_minimal_tuple([[Coup_possible, Valeur] | T], [Coup, Val], [Coup_possible, Valeur]) :-
	Valeur < Val,
	do_get_minimal_tuple(T, [Coup_possible, Valeur], [Coup_possible, Valeur]).

do_get_minimal_tuple([[Coup_possible, Valeur] | T],
						[Coup, Valeur],
						[Coup_courant, Valeur_courante]) :-
						
	Valeur > Val,
	do_get_minimal_tuple(T, [Coup, Valeur], [Coup_courant, Valeur_courante]).


get_minimal_tuple([], [nil, 0]).
get_minimal_tuple([[Coup, Valeur] | Reste_coups_possibles],
					[Coup_minimal, Val_minimal]) :-

	do_get_minimal_tuple(Reste_coups_possibles,
						[Coup_minimal, Val_minimal],
						[Coup, Valeur]).
